...
namespace Stripe.Services
{
        ...
        where TUser : class
    {
        ...
        public async Task<Subscription> SubscribeUserAsync(ApplicationUser user, string planId, DateTime? trialPeriodEnds = null, decimal taxPercent = 0, string stripeId = null)
        {
            var plan = await _dbContext.SubscriptionPlans.FirstOrDefaultAsync(x => x.Id == planId);
